...
# DESC:   Unit test file to determine if a Product can be successfully added to the user's Cart
...
class AddProduct(unittest.TestCase):
    ...
    def test_ll(self):
        ...
        if driver.find_element(By.XPATH, '//*[@id="product_container"]/div/a'):
            ...
            driver.find_element(By.XPATH, '//*[@id="prod_detail_container"]/div/form[1]/input[3]').click()
            time.sleep(3)
